...
{/*    ====    HTML 5     ====
    ...
    +++ <body>   
        ...
        *** ФОРМЫ
        ...
        Тег форм обворачивает все инпуты. Нейм - имя формы, action - адресс скрипта который будет обрабатывать данные формы
            куда отправляем), method - каким методом передается информация(POST - защищенный, GET - передает данные в адрессной
            строке).
