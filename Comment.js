...
{/*    ====    Препроцесори (3.4)    ====
    ...
                    }	
                ...
                *** Можно создавать миксины(объект с несколькими часто повторяющимися вместе свойствам, потом при использовании 
                    в качестве свойства, можно менять конкретный его параметр для текущего стиля)
...
{/*    ====    Практичне заняття: встановлюємо та налаштовуємо SCSS (3.4.4)    ====
